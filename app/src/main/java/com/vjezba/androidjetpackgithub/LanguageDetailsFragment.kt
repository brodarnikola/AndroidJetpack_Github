...
class LanguageDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<FragmentLanguageDetailsBinding>(
            ...
            callback = Callback { repoDetails ->
                repoDetails?.let {
                    hideAppBarFab(fab)
                    languageDetailsViewModel.addPlantToGarden()
                    Snackbar.make(root, R.string.saved_language_successfully, Snackbar.LENGTH_LONG)
                        .show()
                }
            }
    ...
    private fun navigateToGallery() {
        languageDetailsViewModel.languageDetails.value?.let { language ->
            val direction =
                LanguageDetailsFragmentDirections.actionLanguageDetailFragmentToGalleryFragment(language.name)
