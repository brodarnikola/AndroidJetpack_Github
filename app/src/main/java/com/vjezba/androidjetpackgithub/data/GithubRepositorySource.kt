...
class GithubRepositorySource(
    private val service: GithubRepositoryRetrofit,
    private val query: String
) : PagingSource<Int, RepositoryDetailsResponse>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, RepositoryDetailsResponse> {
